    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <hr />
          <p>
            I'm Johnathan, a South African that arrived in London on an
            ancestral work visa, in December 2022. Whilst working full time in
            recruitment, I have been studying a BSC in Computing through the
            University of South Africa. I will complete my degree by the end of
            2023.
          </p>
          <p>
            I'm a goal-driven individual, passionate about coding, fitness and
            philosophy.
          </p>
          <p>
            The reason for my immigration to the UK is to pursue a career in
            tech. I am looking for an opportunity at a company, where I can be a
            asset, broaden my expertise and grow as a developer and individual.
          </p>
        </div>
        ...
        <div className="stage-cube-cout">
          <div className="cubespinner">
            {' '}
            {/* cube for about page using scss styling */}
