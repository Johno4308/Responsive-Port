...
const Projects = () => {
  ...
  useEffect(() => {
    //use effect for title animation
    setTimeout(() => {
  ...
  useEffect(() => {
    //use effect for gsap animations
            ...
            >
              ...
              >
                <div className="project-content">
                  ...
                  <h3>Project Idea</h3>
                  <p>
                    Server program to stack cylinder and box objects onto
                    pallets and send the XML objects over a network to client
                    program, which displays shipping objects in a table model
                    view.
                  </p>
              ...
              >
                <div className="project2-content">
                  ...
                  <h3>Project Idea</h3>
                  <p>
                    To create a 5 room BnB booking application that books in
                    guests, checks dates and room availability
                  </p>
                  <h3>To Demonstrate</h3>
                  <ul>
                    <li>
                      {' '}
                      To hard code a UI without using QT onboard designer
                    </li>
                ...
                <div className="project2-model">
                  <Canvas camera={{ fov: 80, position: [0, 30, 50] }}>
                    <Suspense fallback={null}>
                      ...
                      <directionalLight intensity={1} positon={[0, 25, 50]} />
                      <Bed />
                      <OrbitControls
                        enablePan={true}
                        enableZoom={true}
              ...
              >
                <div className="project-content">
                  ...
                  <h3>Project Idea</h3>
                  <p>
                    To design a calculator with four basic operations, namely
